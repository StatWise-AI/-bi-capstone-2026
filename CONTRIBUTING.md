...
You'll get an invite from GitHub (email or a notification) once the
instructor adds you. Click **Accept invitation**. If you don't have a
GitHub account yet, accepting the invite will prompt you to create one
